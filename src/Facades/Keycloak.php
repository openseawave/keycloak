 ...
 * @method static \OpenSeaWave\Keycloak\Keycloak setGrantType(string $grantType) Set the grant type for Keycloak.
 ...
 * @method static bool createRole(CreateRoleRequest $data, ?string $realm) Create a new role in the realm.
 * @method static void updateRole(string $roleName,array $data,?string $realm) Update an existing role.
 * @method static void deleteRole(string $roleName,?string $realm) Delete a role from the realm.
 * @method static array getUserRoles(string $userId,?string $realm) Retrieve roles assigned to a specific user.
 * @method static void addUserRoles(string $userId, AddUserRolesRequest $roles, ?string $realm) Assign roles to a user.
 * @method static void deleteUserRoles(string $userId, DeleteUserRolesRequest $roles, ?string $realm) Remove roles from a user.
